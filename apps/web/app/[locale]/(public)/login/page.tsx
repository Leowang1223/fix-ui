          ...
          <div className="grid gap-4 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="glass-outline p-5 rounded-2xl transform transition hover:scale-105 hover:shadow-md">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-700">{t('keepStreak')}</p>
                  <p className="text-sm text-slate-500 mt-1">{t('keepStreakDesc')}</p>
                </div>
              </div>
            </div>
            <div className="glass-outline p-5 rounded-2xl transform transition hover:scale-105 hover:shadow-md">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-700">{t('syncEverywhere')}</p>
                  <p className="text-sm text-slate-500 mt-1">{t('syncEverywhereDesc')}</p>
                </div>
              </div>
            </div>
          </div>
